...
## Introduction
This repository is an ALX Holberton School Project. The school project consisted in writing a shell like `sh` (Bourne Shell) by Stephen Bourne , in `C`, using a limited number of standard library functions, so instead we used our own function that we rewrited over the past three month [Here.](https://github.com/coda99/alx-low_level_programming)
...
`git clone https://github.com/coda99/simple_shell.git`
...
### ANDRE OBU
- [GitHub](https://github.com/coda99)
